...
from Api.User import ShortConfig, NewUser
from Api.Resource import ClipV2Resource
from Api.EventStream import EventStream
from Api.ClipV2 import ClipV2
from Api.ResourceElements import ResourceElements
from Api.ClipV2ResourceId import ClipV2ResourceId
...
class HueApi:
    ...
    def __init__(self, confing_service: Config, bridge_service: Bridge) -> None:
